...
Software and hardware requirements Participants require:

```         
A laptop on which they have admin rights (you can install software)
The following software installed on your laptop: Git, R, R Studio, Quarto (full instructions will be sent out to registered participants in advance)
A GitHub account
```
